...
int main(){
    ...
    while(ativo != 11){
        ...
        printf("Digite [8] para imprimir a pilha de modo REVERSO\n");
        printf("Digite [9] para imprimir a pilha por impares e pares separadamente\n");
        printf("Digite [10] para eliminar um elemento da pilha\n");
